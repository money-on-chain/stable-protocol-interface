    ...
    return (
        <div className="ShowTokenMigration">
            <div className="NotificationMigration">
                ...
                <div className="Information">RIF Dollar (RDOC) is changing to RIF USD (USDRIF). You need to swap your RIF Dollars to operate with the updated DAPP. You will no longer be able to see your RDOC balances in the DAPP. Please swap your tokens using the Swap Now button.</div>
