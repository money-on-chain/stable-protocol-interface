        ...
        <table>
            <tbody>
                ...
                <tr className="ant-descriptions-row">
                    ...
                    >
                        {t(
                            `${AppProject}.operations.columns_detailed.txRequest`,
                            { ns: ns }
                        )}
                    </th>
                    <td
                ...
                <tr className="ant-descriptions-row">
                    <th
                        ...
                        colSpan="1"
                    >
                        {t(`${AppProject}.operations.columns_detailed.amount`, {
                            ns: ns
                        })}
                    </th>
                    <td
                    ...
                    >
                        {t(
                            `${AppProject}.operations.columns_detailed.gasCost`,
                            { ns: ns }
                        )}
                    </th>
                    ...
                    <th
                        ...
                        colSpan="1"
                    >
                        {t(`${AppProject}.operations.columns_detailed.txSent`, {
                            ns: ns
                        })}
                    </th>
                    <td
                ...
                <tr className="ant-descriptions-row">
                    ...
                    <td
                        ...
                        colSpan="1"
                    >
                        <span>{props.detail.address} </span>
                    </td>
                    <th
                        className="ant-descriptions-item-label-th ant-descriptions-border-bottom"
                        colSpan="1"
                    >
                        {t(`${AppProject}.operations.columns_detailed.status`, {
                            ns: ns
                        })}
                    </th>
                    <td
                ...
                <tr className="ant-descriptions-row">
                    ...
                    >
                        {t(
                            `${AppProject}.operations.columns_detailed.transaction`,
                            { ns: ns }
                        )}
                    </th>
                    <td
                    ...
                    >
                        {t(
                            `${AppProject}.operations.columns_detailed.mocPrice`,
                            { ns: ns }
                        )}
                    </th>
                    <td
