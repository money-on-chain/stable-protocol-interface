...
const getColumns = (renderActionsFunction, t) => [
    ...
    },
    {
        ...
        key: 'expiration',
        render: (expiration) =>
            moment(parseInt(expiration) * 1000).format('L LT')
    },
    {
        ...
        render: (status) =>
            status === withdrawalStatus.available
                ? t('global.StakingOptions_AvailableToWithdraw', {
                      ns: 'global'
                  })
...
export default function RewardsStakingOptions(props) {
                ...
                <Row className="WithdrawTabFooter">
                    <Col xs={24} md={8}>
                        <div className="WithdrawCTALabel">
                            <span className="grey">
                                {t('global.StakingOptions_PendingExpiration', {
                                    ns: 'global'
                                })}
                            </span>
                    ...
                    <Col xs={24} md={16}>
                        <Row>
                            <Col xs={12} md={10}>
                                <span className="grey">
                                    {t(
                                        'global.StakingOptions_AvailableToWithdraw',
                                        { ns: 'global' }
                                    )}
                                </span>
                                <div className="bolder">
        ...
        <>
            <Row>
                <Col xs={11}>
                    ...
                    >
                        {t('global.StakingOptions_Restake')}
                    </Button>
                </Col>
                <Col xs={1} />
                <Col xs={11}>
                    <Button
                        ...
                        disabled={
                            ...
                            blockedWithdrawals.includes(record.id)
                        }
                        onClick={() => {
                            setWithdrawalId(record.id);
                            setModalAmount(record.amount);
                    ...
                    >
                        {t('global.StakingOptions_Withdraw')}
                    </Button>
                </Col>
            </Row>
        </>
    ...
    return (
        <div className="Card RewardsStakingOptions">
            ...
            <Tabs activeKey={selectedTab} onChange={(n) => setSelectedTab(n)}>
                ...
                <TabPane
                    tab="Withdraw"
                    key={2}
                    className="RewardsOptionsContainer"
                >
                    {renderWithdraw()}
                </TabPane>
            </Tabs>
