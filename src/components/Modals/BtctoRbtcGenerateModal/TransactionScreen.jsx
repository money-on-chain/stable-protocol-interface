...
import {
    urlBtcExplorer,
    urlExplorerUrl
} from '../../../lib/fastBTC/fastBTCMethods';
...
const TransactionInfo = ({ txId, txName, state }) => {
            ...
            <a
                ...
                href={
                    (txId === TxId.DEPOSIT
                        ...
                        : `${urlExplorerUrl}`) +
                    '/tx/' +
                    (txId === TxId.DEPOSIT ? state.depositTx : state.transferTx)
                        .txHash
                }
            >
                {(txId === TxId.DEPOSIT ? state.depositTx : state.transferTx)
    ...
    return (
        <div>
            ...
            <p className="transaction-btc-sections-p font-size-12">
                {t(
                    `${AppProject}.fastbtc.topUpWalletModal.transactionInfo.valueDeposited`,
                    {
                        ns: ns,
                        value:
                            txId === TxId.DEPOSIT
                                ? t(
                                      `${AppProject}.fastbtc.topUpWalletModal.valueBTC`,
                                      {
                                          ns: ns,
                                          value: (txId === TxId.DEPOSIT
                                              ? state.depositTx
                                              : state.transferTx
                                          ).value
                                      }
                                ...
                                : t(
                                      `${AppProject}.fastbtc.topUpWalletModal.valueRBTC`,
                                      {
                                          ns: ns,
                                          value: (txId === TxId.DEPOSIT
                                              ? state.depositTx
            ...
            <p className="transaction-btc-sections-p font-size-12">
                {t(
                    `${AppProject}.fastbtc.topUpWalletModal.transactionInfo.fromLabel`,
                    {
                        ns: ns,
                        value:
                            txId === TxId.DEPOSIT
            ...
            {state.deposit && (
                <span>
                    ...
                    <p className="transaction-btc-sections-p font-size-12">
                        {t(
                            `${AppProject}.fastbtc.topUpWalletModal.transactionInfo.toLabel`,
                            { ns: ns }
                        )}{' '}
                        {(txId === TxId.DEPOSIT
            ...
            <p className="transaction-btc-sections-p font-size-12">
                {t(
                    `${AppProject}.fastbtc.topUpWalletModal.transactionInfo.txHashLabel`,
                    { ns: ns }
                )}{' '}
                {txBtn}
            </p>
            ...
            {state.depositTx.status === '' ? (
                ...
                <div className="transactions-details-container">
                    <div className="transaction-details mrb-4">
                        <h3 className="transaction-btc-title font-size-12">
                            {t(
                                `${AppProject}.fastbtc.topUpWalletModal.transaction1DetailsTitle`,
                                { ns: ns }
                            )}
                        </h3>
                        <TransactionInfo
                    ...
                    <div className="transaction-details mrb-35 mrt-25">
                        <h3 className="transaction-btc-title font-size-12">
                            {t(
                                `${AppProject}.fastbtc.topUpWalletModal.transaction2DetailsTitle`,
                                { ns: ns }
                            )}
                        </h3>
                        <TransactionInfo
                        ...
                        />
                        <greenLogo
                            className="logo-img img-reload"
                            width={17}
                            height={17}
                            alt=""
                        />
                        <rbtcLogo
                            className="logo-img img-set2"
                            width={128}
                            height={128}
                            alt=""
                        />
