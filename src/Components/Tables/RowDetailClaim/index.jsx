        ...
        <table>
            <tbody>
                <tr className="ant-descriptions-row">
                    ...
                    <th className="ant-descriptions-item-label-th ant-descriptions-border-bottom" colSpan="1">{t(`${appMode}.operations.columns_detailed.gas`, { ns: ns })}</th>
                ...
                <tr className="ant-descriptions-row">
                    ...
                    <th className="ant-descriptions-item-label-th ant-descriptions-border-bottom" colSpan="1">{t(`${appMode}.operations.columns_detailed.txRequest`, { ns: ns })}</th>
                    <td className="ant-descriptions-item-content ant-descriptions-border-bottom" colSpan="1">
                ...
                <tr className="ant-descriptions-row">
                    <th className="ant-descriptions-item-label-th ant-descriptions-border-bottom" colSpan="1">{t(`${appMode}.operations.columns_detailed.amount`, { ns: ns })}</th>
                    <td className="ant-descriptions-item-content ant-descriptions-border-bottom" colSpan="1">
                        {props.detail.amount}
                    </td>
                    <th className="ant-descriptions-item-label-th ant-descriptions-border-bottom" colSpan="1">{t(`${appMode}.operations.columns_detailed.gasCost`, { ns: ns })}</th>
                    <td className="ant-descriptions-item-content" colSpan="1">
                        {props.detail.gas_cost}
                    </td>
                    <th className="ant-descriptions-item-label-th ant-descriptions-border-bottom" colSpan="1">{t(`${appMode}.operations.columns_detailed.txSent`, { ns: ns })}</th>
                    <td className="ant-descriptions-item-content ant-descriptions-border-bottom" colSpan="1">
                ...
                <tr className="ant-descriptions-row">
                    ...
                    <th className="ant-descriptions-item-label-th ant-descriptions-border-bottom" colSpan="1">{t(`${appMode}.operations.columns_detailed.status`, { ns: ns })}</th>
                    <td className="ant-descriptions-item-content ant-descriptions-border-bottom" colSpan="1">
                        {props.detail.status}
                    </td>
                </tr>
                <tr className="ant-descriptions-row">
                    ...
                    <th className="ant-descriptions-item-label-th ant-descriptions-border-bottom" colSpan="1">{t(`${appMode}.operations.columns_detailed.transaction`, { ns: ns })}</th>
                    <td className="ant-descriptions-item-content ant-descriptions-border-bottom" colSpan="1">
                        {props.detail.transaction}
                    </td>
                    <th className="ant-descriptions-item-label-th ant-descriptions-border-bottom" colSpan="1">{t(`${appMode}.operations.columns_detailed.mocPrice`, { ns: ns })}</th>
                    <td className="ant-descriptions-item-content ant-descriptions-border-bottom" colSpan="1">
