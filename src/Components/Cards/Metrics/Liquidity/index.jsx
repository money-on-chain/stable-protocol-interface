    ...
    return (
        <div className="Card CardSystemStatus">
            <h3 className="CardTitle" style={{ fontSize: '1.4em' }}>
                {t(`${AppProject}.metrics.bucketsInTokens.title`, { ns: ns })} {t(`${AppProject}.Tokens_RISKPRO_name`, { ns: ns })} | {t(`${AppProject}.metrics.bucketsInTokens.title`, { ns: ns })} {t(`${AppProject}.Tokens_RISKPROX_name`, { ns: ns })}
            </h3>
            ...
            <div className="CardMetricContent BProThemeMetric">
               {!loading
                ? <><div>
                        ...
                        <h5>{t(`${AppProject}.metrics.bucketsInTokens.total`, { ns: ns })} {t(`${AppProject}.Tokens_STABLE_name`, { ns: ns })}</h5>
                        <LargeNumber amount={props.b0DocAmount} currencyCode={'STABLE'} />
                        <h5>{t(`${AppProject}.metrics.bucketsInTokens.total`, { ns: ns })} {t(`${AppProject}.Tokens_RISKPRO_name`, { ns: ns })}</h5>
                    ...
                    <div className="separator" /><div>
                        ...
                        <h5>{t(`${AppProject}.metrics.bucketsInTokens.total`, { ns: ns })} {t(`${AppProject}.Tokens_RISKPROX_name`, { ns: ns })}</h5>
