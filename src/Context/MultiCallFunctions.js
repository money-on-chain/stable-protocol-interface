...
const contractStatus = async (
    ...
    d_moc_state['bitcoinPrice'] = new BigNumber(web3.utils.fromWei(listReturnData[0])).toFixed(4);
    ...
    d_moc_state['bproPriceInUsd'] = new BigNumber(web3.utils.fromWei(listReturnData[23])).toFixed(4);
...
const userBalance = async (
    ...
    user_balance['docBalance'] = new BigNumber(web3.utils.fromWei(listReturnData[2])).toFixed(4);
    user_balance['bproBalance'] = new BigNumber(web3.utils.fromWei(listReturnData[3])).toFixed(4);
    user_balance['rbtcBalance'] = listReturnData[4];
    user_balance['docToRedeem'] = listReturnData[5];
    user_balance['bprox2Balance'] = new BigNumber(web3.utils.fromWei(listReturnData[6])).toFixed(4);
