        ...
        RESERVE: {
            TG_COMMISSION: {
                APP_MODE_MoC: {
                    ...
                    transactionTypeId:
                        TransactionTypeIdsMoC.REDEEM_BTCX_FEES_MOC
                },
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.REDEEM_RISKPROX_FEES_MOC
                }
            },
            RESERVE_COMMISSION: {
                APP_MODE_MoC: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsMoC.REDEEM_BTCX_FEES_RBTC
                },
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.REDEEM_RISKPROX_FEES_RESERVE
                }
            }
        }
    },
        ...
        RESERVE: {
            TG_COMMISSION: {
                APP_MODE_MoC: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsMoC.REDEEM_BPRO_FEES_MOC
                },
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.REDEEM_RISKPRO_FEES_MOC
                }
            },
            RESERVE_COMMISSION: {
                APP_MODE_MoC: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsMoC.REDEEM_BPRO_FEES_RBTC
                },
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.REDEEM_RISKPRO_FEES_RESERVE
                }
            }
        }
    },
        ...
        RESERVE: {
            TG_COMMISSION: {
                ...
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.REDEEM_STABLETOKEN_FEES_MOC
                }
            },
            RESERVE_COMMISSION: {
                APP_MODE_MoC: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsMoC.REDEEM_DOC_FEES_RBTC
                },
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.REDEEM_STABLETOKEN_FEES_RESERVE
                }
            }
        }
    },
        ...
        TC: {
            TG_COMMISSION: {
                ...
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.MINT_RISKPRO_FEES_MOC
                }
            },
            RESERVE_COMMISSION: {
                APP_MODE_MoC: {
                ...
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.MINT_RISKPRO_FEES_RESERVE
                }
            }
        },
        TP: {
            TG_COMMISSION: {
                ...
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.MINT_STABLETOKEN_FEES_MOC
                }
            },
            RESERVE_COMMISSION: {
                APP_MODE_MoC: {
                ...
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.MINT_STABLETOKEN_FEES_RESERVE
                }
            }
        },
        TX: {
            TG_COMMISSION: {
                ...
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.MINT_RISKPROX_FEES_MOC
                }
            },
            RESERVE_COMMISSION: {
                APP_MODE_MoC: {
                ...
                APP_MODE_RRC20: {
                    exchangeFunction: null,
                    transactionTypeId:
                        TransactionTypeIdsRRC20.MINT_RISKPROX_FEES_RESERVE
                }
            }
        }
    }
...
const getExchangeMethod = (
    sourceCurrency,
    targetCurrency,
    commissionCurrency
) => {
    return buyCurrencyMap[sourceCurrency][targetCurrency][commissionCurrency][
        appModeString
    ].exchangeFunction;
};
...
const getTransactionType = (
    ...
    let TransactionTypeIds =
        appMode === 'MoC' ? TransactionTypeIdsMoC : TransactionTypeIdsRRC20;
    return Object.keys(TransactionTypeIds).find(
        (k) =>
            TransactionTypeIds[k] ===
            buyCurrencyMap[sourceCurrency][targetCurrency][commissionCurrency][
                appModeString
            ]?.transactionTypeId
    );
};

export { getExchangeMethod, getTransactionType };
