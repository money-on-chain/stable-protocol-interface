    ...
    return (
        <Fragment>
            ...
            <h3 className="PageSubTitle">
                {t(`${AppProject}.wallets.TX.subtitle`, { ns: ns })}
            </h3>
            <Row gutter={15}>
                ...
                <Col xs={24} md={12} xl={5}>
                    <Row>
                        <Col span={24} style={{ minHeight: '163px' }}>
                            <div
                                className="Card MintCard CardSettlement"
                                style={{ minHeight: '100%' }}
                            >
                                <h3 className="CardTitle">
                                    {t('global.txWallet_NextSettlement', {
                                        ns: 'global'
                                    })}
                                </h3>
                                {auth.isLoggedIn && (
                                    <>
                                        {!loading ? (
                                            <Row>
                                                <h2>
                                                    {t(
                                                        `${AppProject}.settlement.remainingDays`,
                                                        {
                                                            ns: ns,
                                                            days: daysHours?.days,
                                                ...
                                                <div className="CaptionDateSettlement">
                                                    {daysHours?.date}
                                                </div>
                                                <div>
                                                    <span className="SettlementTitle">
                                                        {t(
                                                            `${AppProject}.settlement.remainingBlocks`,
                                                            { ns: ns }
                                                        )}
                                                        :{' '}
                                                    </span>
                        ...
                        <Col
                            span={24}
                            style={{ marginTop: '1em', minHeight: '163px' }}
                        >
                                ...
                                {!loading ? (
                                    <>
                                        ...
                                        <div>
                                            {/*<span>0.027379</span>*/}
                                            <LargeNumber
                                                amount={formatDecimalRatioAsPercent(
                                                    inrateToSettlement
                                                )}
                                                showCurrencyCode
